		...
		for (int i = 0; i < MAX_NUM_OSC_WAVES; i++)
		{
			...
			switch (i)
			{
				...
				case BANK_0_WAVE_1:
				{
					...
					wt->initWithBrickFile("C:\\Users\\sammyfuller\\AppData\\Roaming\\RackAFX 7.0\\RackAFXProjects\\SynthCore Main\\PluginObjects\\wavetables\\analog_square_1.tbl");
					break;
				}
				case PARABOLIC_WAVE:
				{
					// --- example of a set of 1 or more tables (multi-tables) at load time
